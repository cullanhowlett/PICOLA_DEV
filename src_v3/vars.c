...
double UnitVec_x; // The unit vector in the x direction (1 means full-range, -1/2 means only negative quadrant, 1/4 means half the positive quadrant etc.)
double UnitVec_y; // The unit vector in the x direction (1 means full-range, -1/2 means only negative quadrant, 1/4 means half the positive quadrant etc.)
double UnitVec_z; // The unit vector in the x direction (1 means full-range, -1/2 means only negative quadrant, 1/4 means half the positive quadrant etc.)
#endif
...
int subtractLPT;  // Whether or not to add the ZA and 2LPT displacement each timestep, switched via the UseCOLA run parameter
